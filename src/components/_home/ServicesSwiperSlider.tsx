...
const desktopImages = [
  {
    ...
    slideTitle: <>Custom embedded <br/>machine controllers</>,
    slidePoints: [
    ...
    <div className="flex flex-col justify-center items-center relative w-full m-auto overflow-hidden 2xl:h-[590px] xl:h-[510px] lg:h-[415px] md:h-[375px] sm:h-[780px] max-[639px]:h-[630px]">
      <div className="relative flex w-full h-full">
        {desktopImages.map((image, index) => {
         const position =
          ...
          return (
            <div key={index} style={style} className="absolute transition-all duration-500 2xl:max-w-[1085px] xl:max-w-[815px] lg:max-w-[725px] md:max-w-[615px] sm:max-w-[505px] max-[639px]:max-w-[320px] max-[450px]:max-w-[calc(100%_-_60px)] w-full">
      ...
      <div className="flex justify-center items-center 2xl:gap-[8px] xl:gap-[6px] md:gap-[5.33px] gap-[8px]">
        {desktopImages.map((_, index) => (
          <button
            key={index}
            className={`2xl:w-[48px] 2xl:h-[6px] xl:w-[36px] xl:h-[4.5px] md:w-[32px] md:h-[4px] w-[48px] h-[6px] rounded-full ${index === activeIndex ? "bg-[#3563E9]" : "bg-gray-300"}`}
