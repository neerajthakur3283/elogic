    ...
    <>  
        <SlickSlider className='[&>.slick-list>.slick-track]:flex 2xl:[&>.slick-list>.slick-track]:gap-[15px] lg:[&>.slick-list>.slick-track]:gap-[11px] [&>.slick-list>.slick-track]:gap-[10px] [&>.slick-arrow]:before:hidden [&>.slick-arrow]:2xl:w-[81.46px] [&>.slick-arrow]:xl:w-[60px] [&>.slick-arrow]:md:w-[54.3px] [&>.slick-arrow]:w-[81.46px] [&>.slick-arrow]:2xl:h-[35.71px] [&>.slick-arrow]:xl:h-[26.78px] [&>.slick-arrow]:md:h-[23.8px] [&>.slick-arrow]:h-[35.71px] [&>.slick-arrow.slick-disabled]:bg-[#E2E2E2] [&>.slick-arrow]:rounded-full [&>.slick-arrow]:bg-center [&>.slick-arrow]:bg-no-repeat [&>.slick-arrow]:bg-[#3563E9] [&>.slick-arrow]:absolute [&>.slick-arrow]:md:!left-[initial] [&>.slick-arrow]:2xl:!right-[72px] [&>.slick-arrow]:xl:!right-[54px] [&>.slick-arrow]:lg:!right-[48px] [&>.slick-arrow]:!right-[5px] max-[767px]:[&>.slick-arrow]:z-[2] max-[767px]:[&>.slick-arrow]:top-[-58px] [&>.slick-arrow]:2xl:top-[16px] [&>.slick-arrow]:lg:top-[12px] [&>.slick-arrow]:md:top-[6px] [&>.slick-arrow]:top-0 [&>.slick-prev]:2xl:!right-[165px] [&>.slick-prev]:xl:!right-[123px] [&>.slick-prev]:lg:!right-[111px] [&>.slick-prev]:md:!right-[82px] [&>.slick-prev]:!right-[initial] [&>.slick-prev]:max-[767px]:!left-[8px] !position-initial [&>.slick-arrow]:!translate-x-0 [&>.slick-arrow]:!translate-y-0 [&>.slick-prev]:bg-[url(../images/long-prev.svg)] [&>.slick-prev.slick-disabled]:bg-[url(../images/long-prev-dark.svg)] [&>.slick-next]:bg-[url(../images/long-next.svg)] [&>.slick-next.slick-disabled]:bg-[url(../images/long-next-dark.svg)] [&>.slick-arrow]:max-[1535px]:bg-24 [&>.slick-arrow]:max-[1279px]:bg-21 [&>.slick-arrow]:max-[767px]:bg-32 max-[767px]:mt-[24px] max-[767px]:max-w-[460px] max-[767px]:!relative max-[767px]:mx-auto max-[480px]:max-w-[calc(100%_-_20px)]' {...settings}>
            {productCardData.map((data, index) => (
                <div key={index} className='after:duration-500 after:transition-all after:absolute after:left-0 after:top-0 after:w-full after:h-full hover:after:bg-[rgba(0,0,0,0.75)] relative 2xl:rounded-[16px] xl:rounded-[12px] lg:px-[48px]rounded-[10px] rounded-[14px] overflow-hidden 2xl:me-[15px]'>
