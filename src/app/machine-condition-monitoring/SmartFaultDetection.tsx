...
function SmartFaultDetection() {
    const featuresCardData = [
        { icon: iconOne, title: <>Fault Detection</>, description: 'Automated fault detection and classification' },
        { icon: iconOne, title: <>ML for Analysis</>, description: 'Root cause analysis with machine learning algorithms' },
        { icon: iconOne, title: <>Warning Systems</>, description: 'Early warning system for developing issues' },
        { icon: iconOne, title: <>Trend Analysis</>, description: 'Historical trend analysis and pattern recognition' },
    ]
    return (
        <>
            <section>
                    ...
                    <div className='bg-[#EEF1F5] 2xl:rounded-[12px] xl:rounded-[8.4px] md:rounded-[7.74px] rounded-[8px]'>
                        ...
                        <div className='2xl:ps-[100px] xl:ps-[76px] lg:ps-[67px] md:ps-[45px] 2xl:pe-[95px] xl:pe-[70px] lg:pe-[25px] md:pe-[50px] 2xl:py-[95px] xl:py-[76px] md:py-[53px] p-[20px] flex items-center justify-between max-[1023px]:flex-col-reverse lg:flex-nowrap flex-wrap'>
                            <div className='2xl:w-[762.5px] xl:w-[571.87px] lg:w-[508.33px] w-full'>
                                <h2 className='font-semibold 2xl:text-[36px] xl:text-[27px] md:text-[24px] text-[22.45px] lg:flex hidden'>Advanced ﻿Diagnostics</h2>
                            ...
                            <div className='2xl:w-[calc(100%_-_762.5px)] xl:w-[calc(100%_-_571.87px)] lg:w-[calc(100%_-_508.33px)] w-full'>
                                <div className='lg:hidden flex mb-[30px]'>
                                    <h2 className='font-semibold text-[24px]'>Advanced ﻿Diagnostics</h2>
                                </div>
