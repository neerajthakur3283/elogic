...
// images
import palletizer from "@/src/assets/images/palletizer.svg";
...
function CostControlAllocation() {
  const costControlCardData = [
    {
      icon: iconOne,
      title: "Predicting with AI",
      description:
        "The utilization of artificial intelligence to predict potential failures in systems and machinery.",
    },
    {
      icon: iconOne,
      title: "Streamlining Maintenance",
      description:
        "Optimizing the scheduling of maintenance tasks to ensure efficiency and minimize downtime.",
    },
    {
      icon: iconOne,
      title: "Forecasting Lifespan",
      description:
        "Forecasting the expected lifespan of various components to enhance reliability and planning.",
    },
    {
      icon: iconOne,
      title: "Planning Maintenance",
      description:
        "Planning maintenance activities based on risk assessment to prioritize critical systems and reduce unexpected failures.",
    },
  ];
  return (
    <>
