...
function Hardware() {
    const hardwaredCardData = [
        {bgCard:'bg-white',titleColor:'text-black',cardTitle:'Sensors',cardPara:'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore.',cardImage:energyMeter,imgWidth:''},
