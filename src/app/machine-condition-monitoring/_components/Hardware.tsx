...
function Hardware() {
    const hardwaredCardData = [
        {bgCard:'bg-white',titleColor:'text-black',cardTitle:'Sensors',cardPara:'Our industry-leading cameras see the world like people do—in dynamic detail. Capturing rich texture and color data to take spatial perception to a whole new level. ',cardImage:energyMeter,imgWidth:''},
