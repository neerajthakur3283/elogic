  ...
  return (
    <>
      <section>
        ...
        className="flex flex-col md:hidden 2xl:px-[72px] xl:px-[54px] lg:px-[48px] px-[20px] 2xl:py-[100px] xl:py-[75px] lg:py-[66px] md:py-[45px] py-[50px]">
          ...
          <div className="grid grid-cols-1 gap-[20px] max-[991px]:flex-wrap overflow-y-hidden">
            {projects.map((data, index) => (
              ...
              >
                <div className="project-img relative w-full imggrdnt after:absolute after:left-0 after:bottom-0 after:h-full after:w-full max-[639px]:h-[180px]">
                  <Image
                    src={data.projectImg}
                    alt="Project"
                    width={1920}
