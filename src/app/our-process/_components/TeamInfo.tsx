...
function TeamInfo() {
  return (
    <>
        <section>
            <div className='bg-[#051731] 2xl:py-[120px] xl:py-[90px] lg:py-[85px] md:py-[66px] py-[45px] 2xl:px-[72px] xl:px-[54px] lg:px-[48px] px-[20px] 2xl:my-[100px] xl:my-[75px] lg:my-[66px] md:my-[45px] my-[50px]'>
