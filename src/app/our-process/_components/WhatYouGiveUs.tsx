  ...
  return (
    <section>
        <div className="2xl:pb-[100px] xl:pb-[75px] md:pb-[25px] pb-[50px]">
            <div className="2xl:px-[60px] xl:px-[45px] md:px-[40px] px-[20px] 2xl:py-[40px] xl:py-[30px] md:py-[26px] py-[20px] mx-auto from-[#E7F1FF] to-[#ffffff] bg-gradient-to-r 2xl:rounded-[20px] xl:rounded-[16px] md:rounded-[14px] rounded-[12px] w-full min-[1536px]:max-w-[1366px] min-[1280px]:max-w-[1024px] min-[992px]:max-w-[910px] flex flex-col relative justify-between max-[991px]:max-w-[calc(100%_-_40px)] max-[991px]:flex-wrap after:2xl:bg-[url('../images/top-left-line-xl.svg')] after:xl:bg-[url('../images/top-left-line-lg.svg')] after:md:bg-[url('../images/top-left-line-md.svg')] after:max-[991px]:hidden after:2xl:-left-[60px] after:xl:-left-[45px] after:md:-left-[37px] after:2xl:top-[84px] after:xl:top-[65px] after:md:top-[58px] after:2xl:h-[696px] after:xl:h-[523px] after:md:h-[464px] after:2xl:w-[150px] after:xl:w-[113px] after:md:w-[100px] after:absolute after:bg-no-repeat">
                ...
                <div className="">
                    <div className="2xl:mt-[40px] xl:mt-[15px] md:mt-[26px] mt-[30px] flex items-start 2xl:gap-[61px] xl:gap-[43px] md:gap-[30px] gap-[30px] max-[991px]:flex-wrap">
