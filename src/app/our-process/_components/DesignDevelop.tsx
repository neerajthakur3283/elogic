...
function DesignDevelop() {
  const firstStepData = [
    {
      colsreverses:
        'order-1 after:absolute after:2xl:w-[263px] after:xl:w-[198px] after:md:w-[176px] after:2xl:h-[24px] after:xl:h-[18px] after:md:h-[16px] after:2xl:bg-[url("../images/step-arrow.svg")] after:xl:bg-[url("../images/step-arrow-lg.svg")] after:md:bg-[url("../images/step-arrow-md.svg")] max-[991px]:after:bg-[url("../images/step-arrow-mb.svg")] max-[991px]:after:!w-[16px] max-[991px]:after:!h-[66px] max-[991px]:after:!left-0 max-[991px]:after:!right-0 max-[991px]:after:!mx-auto max-[991px]:after:!top-[initial] max-[991px]:after:bottom-0 after:2xl:top-[72px] after:xl:top-[60px] after:md:top-[43px] after:2xl:-right-[142px] after:xl:-right-[105px] after:md:-right-[97px] min-[992px]:pb-0 pb-[75px]',
      stepNumber: "01",
      stepIcon: iconOne,
      title: "Requirement",
  ...
  const midStepData = [
    {
      colsreverses:
        'md:order-4 after:absolute after:2xl:w-[263px] after:xl:w-[198px] after:md:w-[176px] after:2xl:h-[24px] after:xl:h-[18px] after:md:h-[16px] after:2xl:bg-[url("../images/step-arrow.svg")] after:xl:bg-[url("../images/step-arrow-lg.svg")] after:md:bg-[url("../images/step-arrow-md.svg")] max-[991px]:after:bg-[url("../images/step-arrow-mb.svg")] max-[991px]:after:!w-[16px] max-[991px]:after:!h-[66px] max-[991px]:after:!left-0 max-[991px]:after:!right-0 max-[991px]:after:!mx-auto max-[991px]:after:!top-[initial] max-[991px]:after:bottom-0 after:2xl:top-[72px] after:xl:top-[60px] after:md:top-[43px] after:2xl:-right-[142px] after:xl:-right-[105px] after:md:-right-[97px] min-[992px]:after:hidden min-[992px]:pb-0 pb-[75px]',
      stepNumber: "05",
      stepIcon: iconFour,
    ...
    {
      colsreverses:
        'md:order-3 after:absolute after:2xl:w-[263px] after:xl:w-[198px] after:md:w-[176px] after:2xl:h-[24px] after:xl:h-[18px] after:md:h-[16px] after:2xl:bg-[url("../images/step-arrow.svg")] after:xl:bg-[url("../images/step-arrow-lg.svg")] after:md:bg-[url("../images/step-arrow-md.svg")] max-[991px]:after:bg-[url("../images/step-arrow-mb.svg")] max-[991px]:after:!w-[16px] max-[991px]:after:!h-[66px] max-[991px]:after:!left-0 max-[991px]:after:!right-0 max-[991px]:after:!mx-auto max-[991px]:after:!top-[initial] max-[991px]:after:bottom-0 after:2xl:top-[72px] after:xl:top-[60px] after:md:top-[43px] after:2xl:-right-[142px] after:xl:-right-[105px] after:md:-right-[97px] min-[992px]:after:rotate-[180deg] min-[992px]:pb-0 pb-[75px]',
      stepNumber: "06",
      stepIcon: iconThree,
  ...
  const firstStepDataDark = [
    {
      colsreverses:
        'order-1 after:absolute after:2xl:w-[263px] after:xl:w-[198px] after:md:w-[176px] after:2xl:h-[24px] after:xl:h-[18px] after:md:h-[16px] after:2xl:bg-[url("../images/step-arrow.svg")] after:xl:bg-[url("../images/step-arrow-lg.svg")] after:md:bg-[url("../images/step-arrow-md.svg")] max-[991px]:after:bg-[url("../images/step-arrow-mb.svg")] max-[991px]:after:!w-[16px] max-[991px]:after:!h-[66px] max-[991px]:after:!left-0 max-[991px]:after:!right-0 max-[991px]:after:!mx-auto max-[991px]:after:!top-[initial] max-[991px]:after:bottom-0 after:2xl:top-[72px] after:xl:top-[51px] after:2xl:-right-[142px] after:xl:-right-[107px] after:md:-right-[97px] after:md:top-[50px] min-[992px]:pb-0 pb-[75px]',
      stepNumber: "01",
  ...
  const midStepDataDark = [
    ...
    {
      colsreverses:
        'md:order-2 after:absolute after:2xl:w-[263px] after:xl:w-[198px] after:md:w-[176px] after:2xl:h-[24px] after:xl:h-[18px] after:md:h-[16px] after:2xl:bg-[url("../images/step-arrow.svg")] after:xl:bg-[url("../images/step-arrow-lg.svg")] after:md:bg-[url("../images/step-arrow-md.svg")] max-[991px]:after:bg-[url("../images/step-arrow-mb.svg")] max-[991px]:after:!w-[16px] max-[991px]:after:!h-[66px] max-[991px]:after:!left-0 max-[991px]:after:!right-0 max-[991px]:after:!mx-auto max-[991px]:after:!top-[initial] max-[991px]:after:bottom-0 after:2xl:top-[72px] after:xl:top-[51px] after:2xl:-right-[142px] after:xl:-right-[107px]  after:md:-right-[97px] after:md:top-[50px] min-[992px]:after:rotate-[180deg] min-[992px]:pb-0 pb-[75px]',
      stepNumber: "06",
      stepIcon: iconThreeWhite,
    ...
    {
      colsreverses:
        'md:order-1 after:absolute after:2xl:w-[263px] after:xl:w-[198px] after:md:w-[176px] after:2xl:h-[24px] after:xl:h-[18px] after:md:h-[16px] after:2xl:bg-[url("../images/step-arrow.svg")] after:xl:bg-[url("../images/step-arrow-lg.svg")] after:md:bg-[url("../images/step-arrow-md.svg")] max-[991px]:after:hidden after:2xl:top-[72px] after:xl:top-[51px] after:2xl:-right-[142px] after:xl:-right-[107px] after:md:-right-[97px] after:md:top-[50px] min-[992px]:after:rotate-[180deg]',
      stepNumber: "07",
      stepIcon: iconTwoWhite,
