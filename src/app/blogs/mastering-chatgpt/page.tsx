...
import UnderstandYourReaders from './_components/UnderstandYourReaderstsx';
                ...
                <div className='flex 2xl:gap-[80px] xl:gap-[60px] lg:gap-[50px] md:gap-[40px] md:flex-nowrap flex-wrap'>
                    <div className="md:hidden w-full mb-[40px]">
                        ...
                        >
                            ...
                            {dropdownOpen
                                ? activeSection
                                    ? sections.find(s => s.title.replace(/\s+/g, '-').toLowerCase() === activeSection)?.title
                                    : 'In this article'
                                : 'In this article'}
                            </span>
                            <span>
                                        ...
                                        <li key={index}>
                                            <a
                                                ...
                                                className={`block px-4 py-2 ${
                                                    activeSection === sectionId ? 'text-[#3464FC]' : 'text-[#424242]'
                                                } hover:bg-gray-100`}
                                            >
                                                {item.title}
                                            </a>
                    ...
                    <aside className='hidden md:block 2xl:w-[465px] xl:w-[400px] lg:w-[370px] md:w-[250px]'>
                        <div className='sticky 2xl:top-[140px] xl:top-[100px] md:top-[90px]'>
                            <h2 className="font-semibold text-[#222325] 2xl:text-[30px] xl:text-[24px] md:text-[20px] text-[18px]">In this article</h2>
                    ...
                    <div>
                        <p className='2xl:text-[20px] xl:text-[18px] lg:text-[17px] text-[15px] font-semibold text-[#222325]'>Like what you see? Share with a friend.</p>
                        <div className='flex gap-3 text-[#222325] 2xl:text-[34px] xl:text-[30px] lg:text-[25px] text-[18px] 2xl:pt-[30px] xl:pt-[22px] pt-[18px]'>
                            <Link href='' className='transition-all duration-500 hover:text-[#3563E9]' target='_blank'><FaFacebookSquare /></Link>
                            <Link href='' className='transition-all duration-500 hover:text-[#3563E9]' target='_blank'><IoLogoWhatsapp /></Link>
                            <Link href='' className='transition-all duration-500 hover:text-[#3563E9]' target='_blank'><FaSquareXTwitter /></Link>
                            <Link href='' className='transition-all duration-500 hover:text-[#3563E9]' target='_blank'><FaLinkedin /></Link>
                        </div>
                    </div>
                </main>
                </div>
