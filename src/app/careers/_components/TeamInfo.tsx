...
function TeamInfo() {
  return (
    <>
        <section>
            <div
            className='bg-[#111B40] 2xl:pt-[40px] 2xl:pb-[100px] xl:pb-[75px] lg:pb-[66px] md:pb-[45px] py-[50px] 2xl:px-[72px] xl:px-[54px] lg:px-[48px] px-[20px]'>
                <motion.div 
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.8, ease: "easeInOut", delay: 0.3}}
                className='flex items-center justify-between 2xl:gap-[165px] xl:gap-[105px] lg:gap-[80px] md:gap-[50px] gap-[35px] container mx-auto min-[1700px]:max-w-[1630px] lg:flex-nowrap flex-wrap'>
