...
// images
import fiverrImg from "@/src/assets/images/downtime-tracking.svg";
...
function SmartFaultDetection() {
  const featuresCardData = [
    ...
    },
    {
      ...
      description: "Identify opportunities for efficiency improvements",
    },
    {
      icon: iconOne,
      title: <>Downtime Analysis</>,
      description:
        "Analyze top causes of machine downtime using Pareto analysis",
    },
    {
      icon: iconOne,
      title: <>Issue Resolution Tracking</>,
      description: "Track resolution of recurring issues",
    },
  ];
  return (
    <>
