...
function ComplianceReporting() {
  const costControlCardData = [
    {icon:iconOne,title:'Energy Compliance Reports',description:'Create comprehensive automated reports that ensure adherence to energy compliance standards and regulations.'},
    {icon:iconOne,title:'Sustainability Metrics Overview',description:'Monitor and analyze sustainability metrics along with the overall environmental impact to ensure that we are making progress towards our ecological goals.'},
    {icon:iconOne,title:'Energy Savings Strategies',description:'Summarize the energy savings and optimization initiatives implemented, including strategies, expected outcomes, and measurable results.'},
    {icon:iconOne,title:'Export Options for Reports',description:'Easily export data in various formats for effective stakeholder reporting. Choose from multiple options to present information clearly.'},
]
  return (
    <>
        <section>
              ...
              <div className='flex items-center justify-between lg:flex-nowrap flex-wrap xl:gap-0 md:gap-5'>
                <div className='2xl:w-[calc(100%_-_762.5px)] xl:w-[calc(100%_-_571.87px)] lg:w-[calc(100%_-_508.33px)] w-full min-[1850px]:pe-[79.5px] max-[1535px]:pe-[35px] max-[1199px]:pe-0'>
                  <div className='lg:hidden flex mb-[30px]'>
                    <h2 className='font-semibold text-[24px] text-white'>Compliance & Reporting</h2>
                  </div>
                  <Image src={palletizer} alt='' />
                </div>
                <div className='2xl:w-[762.5px] xl:w-[571.87px] lg:w-[508.33px] w-full text-white'>
                  <h2 className='font-semibold 2xl:text-[36px] xl:text-[27px] md:text-[24px] text-[22.45px] lg:flex hidden'>Compliance & Reporting</h2>
