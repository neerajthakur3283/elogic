...
function Hardware() {
    const hardwaredCardData = [
        {bgCard:'bg-white',titleColor:'text-black',cardTitle:'Sensors',cardPara:'Level sensors, vibration sensors, temperature & humidity sensors, pressure sensors',cardImage:energyMeter,imgWidth:''},
