...
transition={{ duration: 0.8, ease: "easeInOut", delay: 0.3}}
            className='flex justify-between max-[991px]:flex-wrap 2xl:gap-[40px] 2xl:px-[60px] xl:px-[45px] lg:px-[40px] md:px-[30px] px-[20px] 2xl:py-[40px] xl:py-[30px] md:py-[26px] py-[20px] 2xl:rounded-[20px] xl:rounded-[16px] md:rounded-[14px] rounded-[12px] from-[#E7F1FF] to-[#ffffff] md:bg-gradient-to-r bg-gradient-to-b' key={index}>
